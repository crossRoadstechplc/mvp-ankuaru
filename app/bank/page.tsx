    ...
    <div className="mt-8 space-y-6">
      ...
      <p className="flex flex-wrap gap-3">
        ...
        <span className="self-center text-sm text-slate-600">
          Register new exporters, importers, or processors — then approve on each case.
        </span>
      </p>
      ...
      <details open className={collapsibleDetailsClass}>
        ...
        <div className={collapsibleBodyClass}>
          {queue.length === 0 ? (
            <p className="text-sm text-slate-600">No trades awaiting financing review.</p>
          ) : (
        ...
        <div className={collapsibleBodyClass}>
          {(() => {
            ...
            return risk.length === 0 ? (
              <p className="text-sm text-slate-600">No trades in margin call or liquidation in seed data.</p>
            ) : (
