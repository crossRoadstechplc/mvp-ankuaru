...
import { disaggregateLot, parseDisaggregateLotRequest } from '@/lib/lots/lot-transformation'
...
export async function POST(request: Request) {
  try {
    ...
    const parsed = parseDisaggregateLotRequest(payload)
    ...
    const result = await disaggregateLot({ ...(payload as object), actorId }, projectRoot)
