...
import { applyBankOnboardingReview, parseBankOnboardingReviewRequest } from '@/lib/bank/onboarding-review'
...
export async function POST(request: Request) {
  try {
    ...
    const parsed = parseBankOnboardingReviewRequest(payload)
    ...
    const result = await applyBankOnboardingReview({ ...(payload as object), bankUserId }, projectRoot)
